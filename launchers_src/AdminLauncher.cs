...
{
    public class AdminLauncher : Form
    {
        private const string TARGET_URL = "http://almflhi-solar.futurebot.site/admin";
        ...
        public AdminLauncher()
        {
            ...
            lblMsg.Text = "يرجى التحقق من اتصالك بالإنترنت والمحاولة مرة أخرى للوصول إلى لوحة التحكم.";
            lblMsg.Font = msgFont;
